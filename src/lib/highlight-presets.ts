 ...
 * using the --key-highlight / --key-lit tokens. Indices 1–5 are a rainbow that
 * harmonises with the warm default while spanning the spectrum. `lit` is the
 * brighter playback-flash variant of each.
 */
